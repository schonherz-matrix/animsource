...
void MainWindow::sendAnimChanged() {
	emit animChanged(AnimFactory::getAnim(type_, animSender->getSourceConfiguration(), primary_color_, secondary_color_, num_));
}
...
MainWindow::MainWindow(QWidget *parent): QMainWindow{parent} {
	...
	/* Initalize members */
	animSender = new AnimSender{QCoreApplication::arguments().at(1).toStdString()};
